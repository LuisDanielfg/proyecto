                      ...
                      <div class="col-lg-12">
                        <div class="card-body p-md-5 mx-md-4">
                          ...
                          <form>
                            ...
                            <option value="value1">Informatica</option>
                            <option value="value2" selected>Recursos Humanos</option>
                            <option value="value3">Gerencia</option>
                            </select>
                            ...
                            <input type="submit" value="Aceptar" class="boton2" name="boton2" id="boton2">
